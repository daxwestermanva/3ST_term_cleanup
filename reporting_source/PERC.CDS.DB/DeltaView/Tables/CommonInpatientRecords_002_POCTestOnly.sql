CREATE TABLE [DeltaView].[CommonInpatientRecords_002_POCTestOnly] (
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCIX_CommonInpatientRecords_002_POCTestOnly]
    ON [DeltaView].[CommonInpatientRecords_002_POCTestOnly];
