...
-- Description:	Dataset pulls COMPACT Act Episodes and Eligibility
-- Modifications:
--	
 
-- EXEC [App].[MBC_COMPACT_LSV] @User = 'VHAMASTER\VHAISBBACANJ'	, @Patient = '1003234687'
-- EXEC [App].[MBC_COMPACT_LSV] @User = 'vha21\vhapalminal'		, @Patient = '1002659377'
-- =============================================
CREATE   PROCEDURE [App].[MBC_COMPACT_LSV]
(
	@User VARCHAR(MAX),
...
BEGIN
	...
	--DECLARE @User varchar(max), @Patient varchar(1000); SET @User = 'VHAMASTER\VHAISBBACANJ'	; SET @Patient = '1034459655'
	--DECLARE @User varchar(max), @Patient varchar(1000); SET @User = 'vha21\vhapalminal'		; SET @Patient = '1000652955'
