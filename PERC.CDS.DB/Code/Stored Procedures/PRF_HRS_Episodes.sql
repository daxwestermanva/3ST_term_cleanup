/********************************************************************************************************************
DESCRIPTION: Get unique and continuous episodes of PRF High Risk for Suicide
TEST:
	[EXEC Code.PRF_HRS_Episodes]
UPDATE:
	2018-04-16	RAS		Created proceure with start and end dates.
	2020-08-11	LM		Updated ActiveDays to take date of death into account 
	2020-09-16	LM		Pointed to Common.MasterPatient
********************************************************************************************************************/
CREATE PROCEDURE [Code].[PRF_HRS_Episodes] 
AS
BEGIN
...
EXEC [Maintenance].[PublishTable] 'PRF_HRS.EpisodeDates','#StageEpisodes'
