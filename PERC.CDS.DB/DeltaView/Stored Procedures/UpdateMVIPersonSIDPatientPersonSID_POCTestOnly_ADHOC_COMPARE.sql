...
*******************************************************************/
CREATE PROCEDURE [DeltaView].[UpdateMVIPersonSIDPatientPersonSID_POCTestOnly_ADHOC_COMPARE]
AS
BEGIN
	...
	*/
	...
	SELECT * FROM #StagePatientPersonSIDToMVI;
